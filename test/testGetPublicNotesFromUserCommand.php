		...
		<div id="wrap">
	      	...
	      	<div class="container" >
	        	...
	        	<div class="row" style="padding-left:20px;">
	        		<input type="hidden" id="action" name="action" value="getPublicNotesFromUser" />
...
$(document).ready(function(){
  	...
  	var loginAndGetPublicNotes = function() {
  		...
  		$.getJSON("../php/takeAction.php", {"action" : action}, function(res) {
  	...
  	submit.onclick = loginAndGetPublicNotes;
});
