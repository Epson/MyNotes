		...
		<div id="wrap">
	      	...
	      	<div class="container" >
	        	...
	        	<div class="row" style="padding-left:20px;">
	        		<input type="hidden" id="action" name="action" value="getMyNotes" />
  	...
  	var getMyNotes = function() {
  		...
  		$.getJSON("../php/takeAction.php", {"action" : action}, function(res) {
	  		for( var i = 0; i < res.length; i ++ ) {
	  			...
	  			tr.append($("<td>" + user["target_name"] 	+ "</td>"));
	  			tbody.append(tr);
	  		}
