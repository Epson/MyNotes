		...
		<div id="wrap">
	      	...
	      	<div class="container" >
	        	...
	        	<div class="row" style="padding-left:20px;">
	        		<input type="hidden" name="action" id="action" value="getApplysForEnter" />
...
$(document).ready(function(){
  	...
  	var getApplysForEnter = function() {
  	...
  	submit.onclick = getApplysForEnter;
});
